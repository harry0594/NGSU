        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="footer-info">
              <h3>NGSU</h3>
              <p class="pb-3"><em>Non-Gazetted Staff Union India Meteorological Department.</em>
              </p>
              <p>
              Mausam Bhavan Compound <br>
              New Delhi 110 003<br><br>
                <strong>Phone:</strong> 011 43824483<br>
                <strong>Email:</strong> ngsuimd@gmail.com<br>
              </p>
