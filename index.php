    ...
    <section id="cta" class="cta">
      <div class="container" data-aos="zoom-in">
        ...
        <div class="text-center">
          ...
          <p> NGSU has all time active contact. For any instant query you can contact us as below</p>
          <a class="cta-btn" href="#contact">NGSU head</a>
        </div>
          ...
          <div class="col-lg-4 col-md-6 Gallery-item filter-app">
            <div class="Gallery-wrap">
              ...
              <div class="Gallery-links">
                ...
                <a href="Gallery-details.php" title="More Details"><i class="bx bx-link"></i></a>
              </div>
            </div>
          </div>
    ...
    <section id="contact" class="contact section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Contact</h2>
          <p>NGSU team is always available for your support and query. For any complain and query you can directly contact our team over below details.</p>
        </div>
